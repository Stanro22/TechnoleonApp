        ...
        HStack{
            ...
            TextField("Niveau", text: $niveau)
                ...
                .onChange(of: niveau){ newValue in
                    loggedInUser.teams![0].players![index].playerYoYoScore = Int(niveau)
                }
...
/*struct PlayerYoYoView_Previews: PreviewProvider {
